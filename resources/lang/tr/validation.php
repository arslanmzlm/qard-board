...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'website' => 'Web sitesi',
        'address' => 'Adres',
        'address_link' => 'Adres linki',
        'survey_link' => 'Anket linki',
        'meta_title' => 'Meta başlığı',
        'meta_description' => 'Meta açıklaması',
        'meta_keywords' => 'Meta anahtar kelimeleri',
        'bank_accounts.*.bank_id' => 'Banka',
        'bank_accounts.*.iban' => 'IBAN',
        'platform_accounts.*.platform_id' => 'Platform',
        'platform_accounts.*.link' => 'Link',
        ...
        'address_link_title' => 'Adres linki başlığı',
